...
public class submenuConfiguraciones extends GenericForwardComposer<Component>{
	...
	public void onClick$buttontipotareas(){
  	 ...
  	 centro.removeChild(centro.getFirstChild());
   	   	...
   	   	Window win=(Window) Executions.createComponents("Submenues/submenuTipoTareas.zul", null, null  );
   ...
   public void onClick$buttonequipoTrabajo(){
  	if(centro.getFirstChild()!=null){
  	 centro.removeChild(centro.getFirstChild());
  	 }
  		Window win=(Window) Executions.createComponents("Submenues/submenuEquipoTrabajo.zul", null, null  );
  		 win.setAttribute("centro", centro);
 		win.setTitle("Opciones");
 		win.doModal();
   }  
   ...
   public void onClick$buttonNuevos(){
	  	if(centro.getFirstChild()!=null){
	  	 centro.removeChild(centro.getFirstChild());
	  	 }
